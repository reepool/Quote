    ...
    *,
    ...
    if result.get("domain") == "futures_master_governance":
        ...
        return (
            ...
            f"dce_proxy_leases: `{counts.get('dce_proxy_lease_count', 0)}`\n"
            f"dce_proxy_rotations: `{counts.get('dce_proxy_rotation_count', 0)}`\n"
            f"dce_proxy_successes: `{counts.get('dce_proxy_success_count', 0)}`\n"
            f"dce_proxy_failures: `{counts.get('dce_proxy_failure_count', 0)}`\n"
            f"dce_proxy_expired: `{counts.get('dce_proxy_expired_count', 0)}`\n"
            f"dce_route_rate_limits: `{counts.get('dce_route_rate_limit_count', 0)}`\n"
            f"dce_payload_requests: `{counts.get('dce_payload_request_count', 0)}`\n"
            f"dce_payload_cache_hits: `{counts.get('dce_payload_cache_hit_count', 0)}`\n"
            f"dce_browser_timeouts: `{counts.get('dce_browser_timeout_count', 0)}`\n"
            f"dce_circuit_breaks: `{counts.get('dce_circuit_break_count', 0)}`\n"
            f"dce_circuit_hits: `{counts.get('dce_circuit_break_hit_count', 0)}`\n"
    ...
    if result.get("domain") == "futures_official_trading_calendar_backfill":
        ...
        for item in (result.get("exchanges") or [])[:10]:
            detail_lines.append(
                ...
                f"proxy_leases={item.get('dce_proxy_lease_count', 0)}, "
                f"proxy_rotations={item.get('dce_proxy_rotation_count', 0)}, "
                f"proxy_successes={item.get('dce_proxy_success_count', 0)}, "
                f"proxy_failures={item.get('dce_proxy_failure_count', 0)}, "
                f"proxy_expired={item.get('dce_proxy_expired_count', 0)}, "
                f"route_rate_limits={item.get('dce_route_rate_limit_count', 0)}, "
                f"payload_requests={item.get('dce_payload_request_count', 0)}, "
                f"payload_cache_hits={item.get('dce_payload_cache_hit_count', 0)}, "
                f"browser_timeouts={item.get('dce_browser_timeout_count', 0)}, "
                f"circuit_breaks={item.get('dce_circuit_break_count', 0)}, "
                f"circuit_hits={item.get('dce_circuit_break_hit_count', 0)}, "
        ...
        return (
            ...
            f"dce_proxy_leases: `{totals.get('dce_proxy_lease_count', 0)}`\n"
            f"dce_proxy_rotations: `{totals.get('dce_proxy_rotation_count', 0)}`\n"
            f"dce_proxy_successes: `{totals.get('dce_proxy_success_count', 0)}`\n"
            f"dce_proxy_failures: `{totals.get('dce_proxy_failure_count', 0)}`\n"
            f"dce_proxy_expired: `{totals.get('dce_proxy_expired_count', 0)}`\n"
            f"dce_route_rate_limits: `{totals.get('dce_route_rate_limit_count', 0)}`\n"
            f"dce_payload_requests: `{totals.get('dce_payload_request_count', 0)}`\n"
            f"dce_payload_cache_hits: `{totals.get('dce_payload_cache_hit_count', 0)}`\n"
            f"dce_browser_timeouts: `{totals.get('dce_browser_timeout_count', 0)}`\n"
            f"dce_circuit_breaks: `{totals.get('dce_circuit_break_count', 0)}`\n"
            f"dce_circuit_hits: `{totals.get('dce_circuit_break_hit_count', 0)}`\n"
