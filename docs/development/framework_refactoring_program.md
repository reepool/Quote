...
移动目标协议的例外登记固定维护在本纲要的“移动目标例外登记”小节；每条登记至少包含日期、涉及的核心文件/旧门面、例外原因、替代 owner、替代 change、最晚清理工作流和复核状态。W8 以该小节作为删除前的唯一登记来源。

### 8.1 移动目标例外登记

当前无已批准例外。新增例外必须在对应 change 修改核心文件前登记，完成替代后更新为已关闭，不得只记录在临时讨论或聊天记录中。
