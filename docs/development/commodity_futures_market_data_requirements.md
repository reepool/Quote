...
> 当前 OpenSpec：`add-futures-market-data-module`、`prioritize-official-futures-sources`、`add-futures-master-calendar-dictionary-api`
...
| `quality_flag` | ok、estimated、manual |
| `metadata` | 节假日、临时休市、来源说明 |
