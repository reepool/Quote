...
- `../../openspec/changes/archive/2026-09-17-deliver-a-share-core-profiles-and-commodity-exposure/`：已归档的全 A 股通用骨架与基础商品暴露实施；生产仍未授权；2026-09-17 首次观察未过 4.1 门槛，现场空交付由 `repair-common-core-empty-delivery-on-owned-pages` 修复；
