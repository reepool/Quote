...
- `../../openspec/changes/archive/2026-09-17-deliver-a-share-core-profiles-and-commodity-exposure/`：已归档的全 A 股通用骨架与基础商品暴露实施；生产仍未授权；2026-09-17 首次观察未过 4.1 门槛；`openspec/changes/archive/2026-09-17-repair-common-core-empty-delivery-on-owned-pages/` 已发布 `owned_page_facts=v3`，重新核原文后 recall 4/7、accuracy 4/4，4.1 仍未通过，不启动 M4；
