...
def test_alias_promotion_builds_valid_new_catalog_and_manifest(tmp_path):
    ...
    output, manifest = build_product_alias_promotion(
        _catalog_payload(),
        expected_catalog_version="business_profile_products.2026.4",
        new_catalog_version="business_profile_products.2026.5",
        ...
        promoted_at="2026-08-22T00:00:00+00:00",
    )
    ...
    assert manifest["source_catalog_version"] == ("business_profile_products.2026.4")
...
def test_promotion_writer_does_not_overwrite_source_or_existing_output(tmp_path):
    ...
    assert written["output_catalog_version"] == ("business_profile_products.2026.5")
...
def test_alias_promotion_rejects_review_after_promotion(tmp_path):
    ...
    evidence["reviewed_at"] = "2026-08-23T00:00:00+00:00"
