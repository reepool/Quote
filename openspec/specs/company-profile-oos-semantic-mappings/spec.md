# company-profile-oos-semantic-mappings Specification

## Purpose
Define bounded semantic mapping corrections discovered during BaoSteel out-of-sample validation without changing historical bundles or production authorization.
