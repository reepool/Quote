...
- 使用经本地正式公告库确认的三份 2025 年年度报告启动共性研究：`300750.SZ` 宁德时代（SZSE）、`603659.SH` 璞泰来（SSE）、`920015.BJ` 锦华新材（BSE）。三者分别挑战电池系统完整产销存/产能、多材料与装备/子公司口径、精细化工产品与匿名客户供应商/BSE 模板。
- 在批准前补充至少一份经正式披露确认的转型、重大重组或借壳制造/材料报告；未找到代表性样本时保留 blocking `coverage_gap`，不得用低相关公司凑数。
