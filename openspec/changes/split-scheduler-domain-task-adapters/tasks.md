...
- [ ] 1.4 Add a scheduler contract test that resolves every configured job id to exactly one callable.
...
- [ ] 3.4 Migrate futures, FX, special-commodity, backup, health, and maintenance jobs to existing domain/operations services.
- [ ] 3.5 Route Telegram `/run`, dated update, and scheduler direct execution through the same adapter resolution.
