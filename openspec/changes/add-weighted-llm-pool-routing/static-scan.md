...
| `llm_config.profiles`, `resource_for_profile` | No application-layer matches outside `utils/llm` and tests | No remaining concrete-profile inspection in business, scheduler, API, or scripts | Release gate passes |
