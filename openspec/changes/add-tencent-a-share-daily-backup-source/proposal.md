...
- 口径可对账：`600000.SH` 2026-09-03 成交量 898172 手 × 100 = 89,817,100 股，与 `quotes.db` 中 pytdx 入库行**精确一致**；`688981.SH`/`689009.SH`（sh688*/sh689*）原始值已是股，量纲规则按代码前缀区分（见 design 决策 3）。
