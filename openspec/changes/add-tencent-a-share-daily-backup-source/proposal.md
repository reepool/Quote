...
- 口径可对账：`000001.SZ` 1105134×100=110,513,400、`300750.SZ` 262864×100=26,286,400、`920000.BJ` 11810×100=1,181,000，均与 `quotes.db` 中 pytdx 行**精确一致**；`600000.SH` 898172×100=89,817,200 vs pytdx 89,817,100，相差 1 手（腾讯按手四舍五入、pytdx 截断，容差 ≤100 股）；`688981.SH`/`689009.SH`（sh688*/sh689*）原始值已是股。量纲规则按代码前缀区分（见 design 决策 3）。
