...
1. **两个入口是本 change 的全部范围。**
   采购行必须由表头、交易方向和行内容共同证明报告主体在采购原材料。三者成立时，原材料单元格或括号中的每个具名材料必须交付投入关系。复合表头含有“服务”等字样时不得整表否决，只按该行的交易方向判断；真正的服务行仍然拒绝。销售、只有泛称采购金额、以及买方主体无法确定的行继续拒绝。
   正式“主要原材料及能源”表中，公司采购或耗用的具名原材料行必须交付，没有数量也必须允许交付。丁酮肟的独立采购或耗用行属于这一正例。蒸汽、电等能源行继续排除。委外加工安排本身仍不能生成投入角色。
