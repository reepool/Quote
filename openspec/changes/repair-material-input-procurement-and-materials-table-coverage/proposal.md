...
- 只覆盖两种披露形态。第一种是公司自身的采购或关联采购行：表头、交易方向和行内容共同成立时，单元格或括号中的每个具名材料必须交付 `material_input` Relationship。复合表头里出现“服务”等字样不得整表否决，按具体行的交易方向判断。真正的服务行、销售行、泛称采购金额，以及无法确定买方主体的行继续拒绝。宁德时代第 73 页只作为验收 fixture，规则不得硬编码证券、页码或材料名。
- 第二种是正式“主要原材料及能源”表。公司采购或耗用的具名原材料行必须交付，没有数量也必须允许交付。丁酮肟的独立采购或耗用行属于这一正例。蒸汽、电等能源行继续排除。委外加工安排本身仍不能生成投入角色。
