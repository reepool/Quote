...
EXTERNAL_OPERATING_OWNERSHIP_SHADOW_REPLAY_CONTRACT = ShadowReplayContract(
    ...
    correction_audit_hash=(
        "529fbc39e9af21a5881d9b85d09da40aba278ca3c286252e08557fc93ae2f776"
    ),
    supporting_artifact_hashes={
        "baseline_batch_manifest": (
            "982ab6ed61c08569683958b263529b66b7161b83fa161519570cf98a5b11eaf5"
        ...
        "failed_readiness_audit": (
            "c2d50fc98aeaf33c16f9b019d53b87d6abc3179c204dcb8eb7ad40835dee571d"
        ),
        "interrupted_attempt": (
            "02a47bbdb9e2b9f1d4bd5bc5163bd2131ea4836ce78d0c6be712ef80cf333ea3"
        ),
        "failed_recurrence_audit": (
            "cffd3fa9ac71bc76b3c055aa37e686a6bbdd4556d4625381c5b43d7e75bab334"
        ),
        "shadow_evidence_implementation": (
            "604048b92487f34dab8bca134a1e3b7a354a374ec12daea02c5ef4c8b8e854fa"
        ),
        ...
        "external_ownership_replay_proof_validator": (
            "e7825dcb19ef6dd7a433a29dad78969904a5f4c1253c003ff1371c0da087015b"
        ),
    },
    primary_logical_profile=SHADOW_PRIMARY_PROFILE,
    extract_max_output_tokens=SHADOW_EXTRACT_MAX_OUTPUT_TOKENS,
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    expected_route = SHADOW_PRIMARY_PROFILE
    ...
    elif args.mode == "external-operating-ownership-semantic-replay":
        required = {
            "external operating ownership replay proof": (
                args.external_operating_ownership_replay_proof
            ),
            "admission receipt": args.admission_receipt,
        }
        missing = [name for name, path in required.items() if path is None]
...
def _validate_replay_mode(
    *,
    ...
    if (
        batch_id == external_operating_ownership_batch
        and mode != "external-operating-ownership-semantic-replay"
    ):
        raise ValueError(
