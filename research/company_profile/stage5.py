...
STAGE5_COMPLETENESS_CANARY_MANIFEST_REVISION = (
    "manufacturing-materials-completeness-canary-manifest-20260912-v1"
)
STAGE5_COMPLETENESS_CANARY_EVIDENCE_PLAN_VERSION = (
    "manufacturing_materials_completeness_canary.2026-09-12.1"
)
STAGE5_COMPLETENESS_CANARY_SAMPLE_ID = (
    "manufacturing-materials-completeness-canary-600426-2025"
)
STAGE5_COMPLETENESS_CANARY_REPORT_ID = "ann_9683e50b9c41f7c3eb67d72f548e2ea4"
STAGE5_COMPLETENESS_CANARY_DOCUMENT_VERSION = (
    "ver_245aadf8bb6533d8f26ece7b1c0727c9"
)
...
COMPLETENESS_CANARY_STAGE5_SAMPLES: dict[str, tuple[str, str]] = {
    STAGE5_COMPLETENESS_CANARY_SAMPLE_ID: (
        "600426.SH",
        "validation_unclassified",
    ),
...
_VALIDATION_PROFILES: dict[str, dict[str, Any]] = {
    ...
    STAGE5_COMPLETENESS_CANARY_MANIFEST_REVISION: {
        ...
        "samples": COMPLETENESS_CANARY_STAGE5_SAMPLES,
        "sample_id": STAGE5_COMPLETENESS_CANARY_SAMPLE_ID,
